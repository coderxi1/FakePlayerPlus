...
class FakeChannel(parent: Channel?, address: InetAddress?): AbstractChannel(parent) {
    companion object {
        val EVENT_LOOP: EventLoop = DefaultEventLoop()
    }
    private val address0 = InetSocketAddress(address, 25565)
    ...
    override fun localAddress0() = address0
    override fun remoteAddress0() = address0
    override fun metadata() = metadata
    override fun eventLoop() = EVENT_LOOP
