...
class PluginPermissionFactory : CommandPermission.Factory<BukkitCommandActor>, PluginComponent {
    override fun create(
        annotations: AnnotationList,
        lamp: Lamp<BukkitCommandActor?>
    ): CommandPermission<BukkitCommandActor?>? {
        val permissionAnno = annotations.get(PluginPermission::class.java) ?: return null
